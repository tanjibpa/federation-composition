      ...
      () => {
        ...
        expect(result.supergraphSdl).toContainGraphQL(/* GraphQL */ `
          type User @join__type(graph: BAR, key: "id") @join__type(graph: FOO, key: "id") {
            id: ID
            name: String @join__field(graph: BAR, overrideLabel: "public") @join__field(graph: FOO, override: "bar", overrideLabel: "public")
          }
        `);
        ...
        expect(result.supergraphSdl).toContainGraphQL(/* GraphQL */ `
          type User @join__type(graph: BAR, key: "id") @join__type(graph: BAZ, key: "id") @join__type(graph: FOO, key: "id") {
            id: ID
            name: String @join__field(graph: BAZ) @join__field(graph: BAR, overrideLabel: "public") @join__field(graph: FOO, override: "bar", overrideLabel: "public")
          }
        `);
